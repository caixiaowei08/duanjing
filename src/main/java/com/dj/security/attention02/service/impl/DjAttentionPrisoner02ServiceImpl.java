package com.dj.security.attention02.service.impl;
...
@Service("djAttentionPrisoner02Service")
@Transactional
public class DjAttentionPrisoner02ServiceImpl extends CommonServiceImpl implements DjAttentionPrisoner02ServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((DjAttentionPrisoner02Entity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((DjAttentionPrisoner02Entity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((DjAttentionPrisoner02Entity)entity);
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DjAttentionPrisoner02Entity t){

package com.dj.security.attention01.service.impl;
...
@Service("djAttentionPrisoner01Service")
@Transactional
public class DjAttentionPrisoner01ServiceImpl extends CommonServiceImpl implements DjAttentionPrisoner01ServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((DjAttentionPrisoner01Entity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((DjAttentionPrisoner01Entity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((DjAttentionPrisoner01Entity)entity);
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DjAttentionPrisoner01Entity t){

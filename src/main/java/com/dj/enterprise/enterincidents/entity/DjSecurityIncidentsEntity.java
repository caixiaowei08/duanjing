package com.dj.enterprise.enterincidents.entity;
 ...
 */
@Entity
@Table(name = "dj_security_incidents", schema = "")
@SuppressWarnings("serial")
public class DjSecurityIncidentsEntity implements java.io.Serializable {
	/**主键*/
	...
	/**地址*/
	@Excel(name="地址")
	private java.lang.String incideAddress;
	/**伤亡情况*/
	@Excel(name="伤亡情况")
	 ...
	 */
	@Column(name ="INCIDE_TIME",nullable=true,length=32)
	 ...
	 */
	@Column(name ="INCIDE_DEPT",nullable=true,length=32)
	 ...
	 */
	@Column(name ="INCIDE_ADDRESS",nullable=true,length=32)
	public java.lang.String getIncideAddress(){
		return this.incideAddress;
	}
	 ...
	 */
	public void setIncideAddress(java.lang.String incideAddress){
		this.incideAddress = incideAddress;
	}
	/**
	 *方法: 取得java.lang.String
	 ...
	 */
	@Column(name ="INCIDE_OFFICER",nullable=true,length=32)

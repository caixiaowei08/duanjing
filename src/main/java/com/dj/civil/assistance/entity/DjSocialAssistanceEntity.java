package com.dj.civil.assistance.entity;
 ...
 */
@Entity
@Table(name = "dj_social_assistance", schema = "")
@SuppressWarnings("serial")
public class DjSocialAssistanceEntity implements java.io.Serializable {
	/**主键*/
	...
	/**救助日期*/
	@Excel(name="救助日期")
	private java.util.Date socialTime;
	/**救助金额*/
	@Excel(name="救助金额")
	private java.lang.String socialMoney;
	/**救助内容*/
	@Excel(name="救助内容")
	private java.lang.String socialContent;
	/**备注*/
	@Excel(name="备注")
	private java.lang.String socialRemark;
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  救助类型
	 */
	@Column(name ="SOCIAL_TYPE",nullable=true,length=32)
	...
	/**
	 *方法: 取得java.util.Date
	 *@return: java.util.Date  救助日期
	 */
	@Column(name ="SOCIAL_TIME",nullable=false,length=32)
	public java.util.Date getSocialTime(){
		return this.socialTime;
	}

	/**
	 *方法: 设置java.util.Date
	 *@param: java.util.Date  救助日期
	 */
	public void setSocialTime(java.util.Date socialTime){
		this.socialTime = socialTime;
	}
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  救助金额
	 */
	@Column(name ="SOCIAL_MONEY",nullable=false,length=32)
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  救助金额
	 */
	public void setSocialMoney(java.lang.String socialMoney){
		this.socialMoney = socialMoney;
	}
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  救助内容
	 */
	@Column(name ="SOCIAL_CONTENT",nullable=true,length=32)
	public java.lang.String getSocialContent(){
		return this.socialContent;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  救助内容
	 */
	public void setSocialContent(java.lang.String socialContent){
	 ...
	 */
	@Column(name ="SOCIAL_REMARK",nullable=true,length=32)
	public java.lang.String getSocialRemark(){
	 ...
	 */
	public void setSocialRemark(java.lang.String socialRemark){

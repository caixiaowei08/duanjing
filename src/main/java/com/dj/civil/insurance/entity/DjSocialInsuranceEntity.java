package com.dj.civil.insurance.entity;
 ...
 */
@Entity
@Table(name = "dj_social_insurance", schema = "")
@SuppressWarnings("serial")
public class DjSocialInsuranceEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  社保类型
	 */
	@Column(name ="SOCIAL_TYPE",nullable=false,length=32)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  入保时间
	 */
	@Column(name ="SOCIAL_ENTER_TIME",nullable=false,length=32)
	public Date getSocialEnterTime(){
		return this.socialEnterTime;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  入保时间
	 */
	public void setSocialEnterTime(Date socialEnterTime){
		this.socialEnterTime = socialEnterTime;
	}
	/**
	 *方法: 取得java.lang.String

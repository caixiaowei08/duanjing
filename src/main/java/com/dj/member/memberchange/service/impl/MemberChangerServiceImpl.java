package com.dj.member.memberchange.service.impl;
...
@Service("memberChangerService")
@Transactional
public class MemberChangerServiceImpl extends CommonServiceImpl implements MemberChangerServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((MemberChangerEntity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((MemberChangerEntity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((MemberChangerEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public boolean doAddSql(MemberChangerEntity t){
	 	return true;
 	}
 	/**
	 * 默认按钮-sql增强-更新操作
	 ...
	 * @return
	 */
 	public boolean doUpdateSql(MemberChangerEntity t){
	 	return true;
 	}
 	/**
	 * 默认按钮-sql增强-删除操作
	 ...
	 * @return
	 */
 	public boolean doDelSql(MemberChangerEntity t){
	 	return true;
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,MemberChangerEntity t){
 		...
 		sql  = sql.replace("#{member_political_status}",String.valueOf(t.getMemberPoliticalStatus()));
 		sql  = sql.replace("#{member_change_reason}",String.valueOf(t.getMemberChangeReason()));
 		sql  = sql.replace("#{member_change_time}",String.valueOf(t.getMemberChangeTime()));

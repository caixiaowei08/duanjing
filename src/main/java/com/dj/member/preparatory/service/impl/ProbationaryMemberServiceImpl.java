package com.dj.member.preparatory.service.impl;
...
@Service("probationaryMemberService")
@Transactional
public class ProbationaryMemberServiceImpl extends CommonServiceImpl implements ProbationaryMemberServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((ProbationaryMemberEntity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((ProbationaryMemberEntity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((ProbationaryMemberEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ProbationaryMemberEntity t){

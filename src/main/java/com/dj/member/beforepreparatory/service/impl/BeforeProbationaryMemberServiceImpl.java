package com.dj.member.beforepreparatory.service.impl;
...
@Service("beforeProbationaryMemberService")
@Transactional
public class BeforeProbationaryMemberServiceImpl extends CommonServiceImpl implements BeforeProbationaryMemberServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((BeforeProbationaryMemberEntity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((BeforeProbationaryMemberEntity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((BeforeProbationaryMemberEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BeforeProbationaryMemberEntity t){

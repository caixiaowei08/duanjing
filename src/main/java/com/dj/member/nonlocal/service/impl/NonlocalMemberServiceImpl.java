package com.dj.member.nonlocal.service.impl;
...
@Service("nonlocalMemberService")
@Transactional
public class NonlocalMemberServiceImpl extends CommonServiceImpl implements NonlocalMemberServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((NonlocalMemberEntity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((NonlocalMemberEntity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((NonlocalMemberEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,NonlocalMemberEntity t){

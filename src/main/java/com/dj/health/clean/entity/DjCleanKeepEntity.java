package com.dj.health.clean.entity;
 ...
 */
@Entity
@Table(name = "dj_clean_keep", schema = "")
@SuppressWarnings("serial")
public class DjCleanKeepEntity implements java.io.Serializable {
	/**主键*/
	...
	/**分管项目*/
	@Excel(name="分管项目")
	private java.lang.String cleanItem;
	/**备注*/
	@Excel(name="备注")
	private java.lang.String cleanRemark;
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  分管项目
	 */
	@Column(name ="CLEAN_ITEM",nullable=false,length=32)
	public java.lang.String getCleanItem(){
		return this.cleanItem;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  分管项目
	 */
	public void setCleanItem(java.lang.String cleanItem){
	 ...
	 */
	@Column(name ="CLEAN_REMARK",nullable=true,length=32)
	public java.lang.String getCleanRemark(){
	 ...
	 */
	public void setCleanRemark(java.lang.String cleanRemark){

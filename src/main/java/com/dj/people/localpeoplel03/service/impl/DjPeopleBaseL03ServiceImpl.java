package com.dj.people.localpeoplel03.service.impl;
...
@Service("djPeopleBaseL03Service")
@Transactional
public class DjPeopleBaseL03ServiceImpl extends CommonServiceImpl implements DjPeopleBaseL03ServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((DjPeopleBaseL03Entity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((DjPeopleBaseL03Entity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((DjPeopleBaseL03Entity)entity);
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DjPeopleBaseL03Entity t){

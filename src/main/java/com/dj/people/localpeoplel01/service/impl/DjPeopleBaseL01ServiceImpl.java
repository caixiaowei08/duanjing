package com.dj.people.localpeoplel01.service.impl;
...
@Service("djPeopleBaseL01Service")
@Transactional
public class DjPeopleBaseL01ServiceImpl extends CommonServiceImpl implements DjPeopleBaseL01ServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((DjPeopleBaseL01Entity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((DjPeopleBaseL01Entity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((DjPeopleBaseL01Entity)entity);
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DjPeopleBaseL01Entity t){

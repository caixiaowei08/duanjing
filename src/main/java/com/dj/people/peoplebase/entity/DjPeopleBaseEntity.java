package com.dj.people.peoplebase.entity;
...
public class DjPeopleBaseEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 *@return: java.lang.String  现居住地区
	 */
	@Column(name ="DISTRICT_CURRENT",nullable=true,length=32)
	 ...
	 */
	@Column(name ="TOWN_CURRENT",nullable=true,length=32)
	 ...
	 */
	@Column(name ="VILLAGE_CURRENT",nullable=true,length=32)
	 ...
	 */
	@Column(name ="RIDGE_NO_CURRENT",nullable=true,length=32)

package com.dj.people.nolocalpeople.entity;
...
public class DjPeopleBaseNLEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="PERMANENT_DISTRICT",nullable=false,length=32)
	 ...
	 */
	@Column(name ="PERMANENT_ADDRESS",nullable=false,length=32)

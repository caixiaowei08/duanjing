package com.dj.people.nolocalpeople.service.impl;
...
@Service("djPeopleBaseNLService")
@Transactional
public class DjPeopleBaseNLServiceImpl extends CommonServiceImpl implements DjPeopleBaseNLServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((DjPeopleBaseNLEntity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((DjPeopleBaseNLEntity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((DjPeopleBaseNLEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public boolean doAddSql(DjPeopleBaseNLEntity t){
	 	return true;
 	}
 	/**
	 * 默认按钮-sql增强-更新操作
	 ...
	 * @return
	 */
 	public boolean doUpdateSql(DjPeopleBaseNLEntity t){
	 	return true;
 	}
 	/**
	 * 默认按钮-sql增强-删除操作
	 ...
	 * @return
	 */
 	public boolean doDelSql(DjPeopleBaseNLEntity t){
	 	return true;
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DjPeopleBaseNLEntity t){

package com.dj.people.localpeoplel02.service.impl;
...
@Service("djPeopleBaseL02Service")
@Transactional
public class DjPeopleBaseL02ServiceImpl extends CommonServiceImpl implements DjPeopleBaseL02ServiceI {

	
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((DjPeopleBaseL02Entity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((DjPeopleBaseL02Entity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((DjPeopleBaseL02Entity)entity);
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,DjPeopleBaseL02Entity t){

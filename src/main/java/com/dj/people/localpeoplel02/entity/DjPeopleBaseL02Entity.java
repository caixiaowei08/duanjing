package com.dj.people.localpeoplel02.entity;
...
public class DjPeopleBaseL02Entity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="CURRENT_DISTRICT",nullable=false,length=32)
	 ...
	 */
	@Column(name ="CURRENT_ADDRESS",nullable=false,length=32)

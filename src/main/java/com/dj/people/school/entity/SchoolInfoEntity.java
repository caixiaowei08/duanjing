...
public class SchoolInfoEntity implements java.io.Serializable {
	...
	@Column(name ="PEO_TYPE",nullable=true,length=4)
	...
	@Column(name ="NATIONALITY",nullable=true,length=10)
	...
	@Column(name ="MARITAL_STATUS",nullable=true,length=4)
	...
	@Column(name ="WORK_ADDRESS",nullable=true,length=50)
	...
	@Column(name ="IS_ARMY",nullable=true,length=4)
	...
	@Column(name ="ARMY_REMARK",nullable=true,length=50)
	...
	@Column(name ="PERMANENT_DISTRICT",nullable=true,length=50)
	...
	@Column(name ="PERMANENT_ADDRESS",nullable=true,length=50)
	...
	@Column(name ="CURRENT_DISTRICT",nullable=true,length=50)
	...
	@Column(name ="CURRENT_ADDRESS",nullable=true,length=50)

package com.dj.people.foreigerpeople.entity;
...
public class DjPeopleBaseFEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="LAST_AME",nullable=false,length=32)
	 ...
	 */
	@Column(name ="ENTRY_TIME",nullable=false,length=32)
	 ...
	 */
	@Column(name ="DUE_TIME",nullable=false,length=32)
	 ...
	 *@return: java.lang.String  户籍地区
	 */
	@Column(name ="DISTRICT_PERM",nullable=true,length=32)
	 ...
	 */
	@Column(name ="TOWN_PERM",nullable=true,length=32)
	 ...
	 */
	@Column(name ="VILLAGE_PERM",nullable=true,length=32)
	 ...
	 */
	@Column(name ="ROOM_NO_PERM",nullable=true,length=32)
	 ...
	 */
	@Column(name ="FLOOR_NO_CURRENT",nullable=false,length=32)
	 ...
	 */
	@Column(name ="ROOM_NO_CURRENT",nullable=false,length=32)

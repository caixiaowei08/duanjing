...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="probationaryMemberController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${probationaryMemberPage.name}'>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${probationaryMemberPage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${probationaryMemberPage.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="permanentAddress" name="permanentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${probationaryMemberPage.permanentAddress}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${probationaryMemberPage.currentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="workAddress" name="workAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${probationaryMemberPage.workAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="job" name="job" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${probationaryMemberPage.job}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="memberApplicationDate" name="memberApplicationDate" type="text" style="width: 150px" class="inputxt"  
									            class="Wdate" onClick="WdatePicker()"
						      				   value='<fmt:formatDate value='${probationaryMemberPage.memberApplicationDate}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="memberIntroducer" name="memberIntroducer" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${probationaryMemberPage.memberIntroducer}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="memberApprover" name="memberApprover" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${probationaryMemberPage.memberApprover}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="memberApproveTime" name="memberApproveTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${probationaryMemberPage.memberApproveTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="memberRemark" name="memberRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${probationaryMemberPage.memberRemark}'>
							<span class="Validform_checktip"></span>

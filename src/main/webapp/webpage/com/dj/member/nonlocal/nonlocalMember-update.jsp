...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="nonlocalMemberController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${nonlocalMemberPage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="permanentAddress" name="permanentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${nonlocalMemberPage.permanentAddress}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${nonlocalMemberPage.currentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="workAddress" name="workAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${nonlocalMemberPage.workAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="memberJoinPartytIme" name="memberJoinPartytIme" type="text" style="width: 150px" class="inputxt"  
						      				   ...
						      				   value='<fmt:formatDate value='${nonlocalMemberPage.memberJoinPartytIme}' type="date" pattern="yyyy-MM-dd"/>'>       
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="memberDues" name="memberDues" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${nonlocalMemberPage.memberDues}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="memberTel" name="memberTel" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${nonlocalMemberPage.memberTel}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="memberRemark" name="memberRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${nonlocalMemberPage.memberRemark}'>
							<span class="Validform_checktip"></span>

...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djBuildingHousesController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djBuildingHousesPage.name}'>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${djBuildingHousesPage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djBuildingHousesPage.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="permanentAddress" name="permanentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBuildingHousesPage.permanentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBuildingHousesPage.currentAddress}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="buildAppliItems" name="buildAppliItems" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djBuildingHousesPage.buildAppliItems}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="buildAppliTime" name="buildAppliTime" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djBuildingHousesPage.buildAppliTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="buildOldStruc" name="buildOldStruc" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBuildingHousesPage.buildOldStruc}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="buildOldArea" name="buildOldArea" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBuildingHousesPage.buildOldArea}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="buildNewStruc" name="buildNewStruc" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBuildingHousesPage.buildNewStruc}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="buildNowArea" name="buildNowArea" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBuildingHousesPage.buildNowArea}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="buildStartTime" name="buildStartTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djBuildingHousesPage.buildStartTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="buildFinishTime" name="buildFinishTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djBuildingHousesPage.buildFinishTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="buildRemark" name="buildRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBuildingHousesPage.buildRemark}'>
							<span class="Validform_checktip"></span>

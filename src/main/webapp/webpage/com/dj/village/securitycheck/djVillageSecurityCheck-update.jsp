...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djVillageSecurityCheckController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
									  <input id="villaTime" name="villaTime" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djVillageSecurityCheckPage.villaTime}' type="date" pattern="yyyy-MM-dd"/>'>    
					...
					<tr>
						...
						<td class="value">
						     	 <input id="villaCheckedDept" name="villaCheckedDept" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djVillageSecurityCheckPage.villaCheckedDept}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="villaItem" name="villaItem" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djVillageSecurityCheckPage.villaItem}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="villaChecker" name="villaChecker" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djVillageSecurityCheckPage.villaChecker}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="villaStatus" name="villaStatus" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djVillageSecurityCheckPage.villaStatus}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="villaRemark" name="villaRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djVillageSecurityCheckPage.villaRemark}'>
							<span class="Validform_checktip"></span>

...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djBusinessManagementController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="businessName" name="businessName" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djBusinessManagementPage.businessName}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="businessDept" name="businessDept" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBusinessManagementPage.businessDept}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="businessTime" name="businessTime" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djBusinessManagementPage.businessTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="businessOperator" name="businessOperator" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djBusinessManagementPage.businessOperator}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="businessHost" name="businessHost" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBusinessManagementPage.businessHost}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="businessJoiners" name="businessJoiners" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBusinessManagementPage.businessJoiners}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="businessDetail" name="businessDetail" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBusinessManagementPage.businessDetail}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="businessRemark" name="businessRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBusinessManagementPage.businessRemark}'>
							<span class="Validform_checktip"></span>

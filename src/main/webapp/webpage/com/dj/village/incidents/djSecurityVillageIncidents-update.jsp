...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djSecurityVillageIncidentsController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
									  <input id="incideTime" name="incideTime" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djSecurityVillageIncidentsPage.incideTime}' type="date" pattern="yyyy-MM-dd"/>'>    
					...
					<tr>
						...
						<td class="value">
						     	 <input id="incideDept" name="incideDept" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djSecurityVillageIncidentsPage.incideDept}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="incideCasualtyNum" name="incideCasualtyNum" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djSecurityVillageIncidentsPage.incideCasualtyNum}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="incideOfficer" name="incideOfficer" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djSecurityVillageIncidentsPage.incideOfficer}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="incideReason" name="incideReason" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djSecurityVillageIncidentsPage.incideReason}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="incideCheckResult" name="incideCheckResult" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djSecurityVillageIncidentsPage.incideCheckResult}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="incideRemark" name="incideRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djSecurityVillageIncidentsPage.incideRemark}'>
							<span class="Validform_checktip"></span>

...
<html>
 <head>
  ...
  $(document).ready(function() {
	  ...
	  var villagePermb= $("#villagePermb").val();
	  var roomNoPermb= $("#roomNoPermb").val();
	  
      $("#villageCurrent option[value='"+villageCurrentb+"']").attr("selected","selected");
	  $("#villagePerm option[value='"+villagePermb+"']").attr("selected","selected");
	  
	  getRidgeNoCurrent();
	  getRidgeNoPerm();
	  
	  $("#ridgeNoCurrent option[value='"+ridgeNoCurrentb+"']").attr("selected","selected");
	  $("#roomNoPerm option[value='"+roomNoPermb+"']").attr("selected","selected");
...
function getRidgeNoPerm(){
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djPeopleBaseL01Controller.do?doUpdate" tiptype="1">
					...
					<input id="villageCurrentb"  type="hidden" value="${djPeopleBaseL01Page.villageCurrent}">
					<input id="ridgeNoCurrentb"  type="hidden" value="${djPeopleBaseL01Page.roomNoPerm }">
					
					<input id="villagePermb"  type="hidden" value="${djPeopleBaseL01Page.villagePerm}">
					<input id="roomNoPermb"  type="hidden" value="${djPeopleBaseL01Page.roomNoPerm }">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djPeopleBaseL01Page.name}'>
						...
						<td class="value">
									  <input id="birthdate" name="birthdate" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djPeopleBaseL01Page.birthdate}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL01Page.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${djPeopleBaseL01Page.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="birthPlace" name="birthPlace" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL01Page.birthPlace}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="usedName" name="usedName" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL01Page.usedName}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="sign" name="sign" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL01Page.sign}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="nation" name="nation" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL01Page.nation}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="height" name="height" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL01Page.height}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="spouseName" name="spouseName" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL01Page.spouseName}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="phone" name="phone" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL01Page.phone}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="workAddress" name="workAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL01Page.workAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="armyRemark" name="armyRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL01Page.armyRemark}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="remark" name="remark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL01Page.remark}'>
							<span class="Validform_checktip"></span>

...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="schoolController.do?doAdd" tiptype="1">
			...
			<div align="center"><label  class="Validform_label">子女信息(搜索)</label></div>
			<hr width=80% size=3 color=#84C1FF style="FILTER: alpha(opacity=100,finishopacity=0,style=1)"> 	
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
								...
								<select id="name" name="name" datatype="*">
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
							...
							<select id="guardian_name" name="guardianName" datatype="*"></select>		   
							<span class="Validform_checktip"></span>

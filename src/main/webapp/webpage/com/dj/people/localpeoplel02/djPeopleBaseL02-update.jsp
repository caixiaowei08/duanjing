...
function getRidgeNoPerm(){
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djPeopleBaseL02Controller.do?doUpdate" tiptype="1">
					...
					<input id="villagePermb"  type="hidden" value="${djPeopleBaseL02Page.villagePerm}">
					<input id="roomNoPermb"  type="hidden" value="${djPeopleBaseL02Page.roomNoPerm }">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djPeopleBaseL02Page.name}'>
						...
						<td class="value">
									  <input id="birthdate" name="birthdate" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djPeopleBaseL02Page.birthdate}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL02Page.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${djPeopleBaseL02Page.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="birthPlace" name="birthPlace" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL02Page.birthPlace}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="usedName" name="usedName" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL02Page.usedName}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="sign" name="sign" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL02Page.sign}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="nation" name="nation" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL02Page.nation}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="height" name="height" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL02Page.height}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="spouseName" name="spouseName" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL02Page.spouseName}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="phone" name="phone" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL02Page.phone}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="workAddress" name="workAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL02Page.workAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="armyRemark" name="armyRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL02Page.armyRemark}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="currentDistrict" name="currentDistrict" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djPeopleBaseL02Page.currentDistrict}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djPeopleBaseL02Page.currentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="remark" name="remark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPeopleBaseL02Page.remark}'>
							<span class="Validform_checktip"></span>

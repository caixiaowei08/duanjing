...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djTreatDetailController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
									  <input id="treatTime" name="treatTime" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djTreatDetailPage.treatTime}' type="date" pattern="yyyy-MM-dd"/>'>    
					...
					<tr>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${djTreatDetailPage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djTreatDetailPage.currentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="treatDetail" name="treatDetail" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djTreatDetailPage.treatDetail}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="treatDoctor" name="treatDoctor" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djTreatDetailPage.treatDoctor}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="treatMedicine" name="treatMedicine" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djTreatDetailPage.treatMedicine}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="treatRemark" name="treatRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djTreatDetailPage.treatRemark}'>
							<span class="Validform_checktip"></span>

...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djCleanKeepController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${djCleanKeepPage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="permanentAddress" name="permanentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djCleanKeepPage.permanentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djCleanKeepPage.currentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="cleanItem" name="cleanItem" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djCleanKeepPage.cleanItem}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="cleanRemark" name="cleanRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djCleanKeepPage.cleanRemark}'>
							<span class="Validform_checktip"></span>

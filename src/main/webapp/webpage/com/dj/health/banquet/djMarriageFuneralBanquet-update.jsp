...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djMarriageFuneralBanquetController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djMarriageFuneralBanquetPage.name}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djMarriageFuneralBanquetPage.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="banquetTel" name="banquetTel" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djMarriageFuneralBanquetPage.banquetTel}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="banquetHomeAddress" name="banquetHomeAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djMarriageFuneralBanquetPage.banquetHomeAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="banquetTime" name="banquetTime" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djMarriageFuneralBanquetPage.banquetTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="banquetItem" name="banquetItem" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djMarriageFuneralBanquetPage.banquetItem}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="banquetPeopleNum" name="banquetPeopleNum" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djMarriageFuneralBanquetPage.banquetPeopleNum}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="banquetTableNum" name="banquetTableNum" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djMarriageFuneralBanquetPage.banquetTableNum}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="banquetAddress" name="banquetAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djMarriageFuneralBanquetPage.banquetAddress}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="banquetRemark" name="banquetRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djMarriageFuneralBanquetPage.banquetRemark}'>
							<span class="Validform_checktip"></span>

...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djBirthControlInController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djBirthControlInPage.name}'>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${djBirthControlInPage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djBirthControlInPage.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="permanentAddress" name="permanentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBirthControlInPage.permanentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBirthControlInPage.currentAddress}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="maritalStatus" name="maritalStatus" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBirthControlInPage.maritalStatus}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="birthinFertilityCondition" name="birthinFertilityCondition" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBirthControlInPage.birthinFertilityCondition}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="birthinContraceptives" name="birthinContraceptives" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBirthControlInPage.birthinContraceptives}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="birthinHealthStatus" name="birthinHealthStatus" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBirthControlInPage.birthinHealthStatus}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="birthinRemark" name="birthinRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djBirthControlInPage.birthinRemark}'>
							<span class="Validform_checktip"></span>

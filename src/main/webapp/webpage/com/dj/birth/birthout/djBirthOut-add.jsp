...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djBirthOutController.do?doAdd" tiptype="1">
				...
				<tr>
					...
					<td class="value">
							...
							<t:dictSelect field="degree" type="list"
									typeGroupCode="degree" hasLabel="false"  title="文化程度"></t:dictSelect> 	               
							<span class="Validform_checktip"></span>

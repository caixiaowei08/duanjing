...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djVaccinationInfoController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djVaccinationInfoPage.name}'>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${djVaccinationInfoPage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="birthdate" name="birthdate" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djVaccinationInfoPage.birthdate}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djVaccinationInfoPage.idNo}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="birthPlace" name="birthPlace" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djVaccinationInfoPage.birthPlace}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="permanentAddress" name="permanentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djVaccinationInfoPage.permanentAddress}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djVaccinationInfoPage.currentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="fatherName" name="fatherName" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djVaccinationInfoPage.fatherName}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="motherName" name="motherName" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djVaccinationInfoPage.motherName}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="phone" name="phone" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djVaccinationInfoPage.phone}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="tel" name="tel" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djVaccinationInfoPage.tel}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="vaccination" name="vaccination" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${djVaccinationInfoPage.vaccination}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="remark" name="remark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djVaccinationInfoPage.remark}'>
							<span class="Validform_checktip"></span>

...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djPreferentialTreatmentController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djPreferentialTreatmentPage.name}'>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${djPreferentialTreatmentPage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djPreferentialTreatmentPage.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="permanentAddress" name="permanentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPreferentialTreatmentPage.permanentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPreferentialTreatmentPage.currentAddress}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="preferType" name="preferType" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPreferentialTreatmentPage.preferType}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="preferTime" name="preferTime" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djPreferentialTreatmentPage.preferTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="preferMoney" name="preferMoney" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djPreferentialTreatmentPage.preferMoney}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="preferContent" name="preferContent" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPreferentialTreatmentPage.preferContent}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="preferRemark" name="preferRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djPreferentialTreatmentPage.preferRemark}'>
							<span class="Validform_checktip"></span>

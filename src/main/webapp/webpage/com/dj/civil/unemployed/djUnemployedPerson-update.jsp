...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djUnemployedPersonController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djUnemployedPersonPage.name}'>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${djUnemployedPersonPage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djUnemployedPersonPage.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="permanentAddress" name="permanentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djUnemployedPersonPage.permanentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djUnemployedPersonPage.currentAddress}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="unemplOldCom" name="unemplOldCom" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djUnemployedPersonPage.unemplOldCom}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="unemplTime" name="unemplTime" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djUnemployedPersonPage.unemplTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="unemplReason" name="unemplReason" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djUnemployedPersonPage.unemplReason}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="unemplJobIntension" name="unemplJobIntension" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djUnemployedPersonPage.unemplJobIntension}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="unemplRemark" name="unemplRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djUnemployedPersonPage.unemplRemark}'>
							<span class="Validform_checktip"></span>

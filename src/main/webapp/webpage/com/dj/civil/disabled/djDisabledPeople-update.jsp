...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djDisabledPeopleController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djDisabledPeoplePage.name}'>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${djDisabledPeoplePage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djDisabledPeoplePage.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="permanentAddress" name="permanentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDisabledPeoplePage.permanentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDisabledPeoplePage.currentAddress}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="disabledNo" name="disabledNo" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDisabledPeoplePage.disabledNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="disabledStatus" name="disabledStatus" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDisabledPeoplePage.disabledStatus}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="disabledDept" name="disabledDept" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDisabledPeoplePage.disabledDept}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="disabledProvideTime" name="disabledProvideTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${djDisabledPeoplePage.disabledProvideTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="disabledGuardian" name="disabledGuardian" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDisabledPeoplePage.disabledGuardian}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="disabledLabor" name="disabledLabor" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDisabledPeoplePage.disabledLabor}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="disabledAbility" name="disabledAbility" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDisabledPeoplePage.disabledAbility}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="disabledRemark" name="disabledRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDisabledPeoplePage.disabledRemark}'>
							<span class="Validform_checktip"></span>

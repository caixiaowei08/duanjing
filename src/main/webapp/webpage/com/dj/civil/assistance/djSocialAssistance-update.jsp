...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djSocialAssistanceController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djSocialAssistancePage.name}'>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${djSocialAssistancePage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djSocialAssistancePage.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="permanentAddress" name="permanentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djSocialAssistancePage.permanentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djSocialAssistancePage.currentAddress}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="socialType" name="socialType" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djSocialAssistancePage.socialType}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="socialTime" name="socialTime" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djSocialAssistancePage.socialTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="socialMoney" name="socialMoney" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djSocialAssistancePage.socialMoney}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="socialContent" name="socialContent" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djSocialAssistancePage.socialContent}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="socialRemark" name="socialRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djSocialAssistancePage.socialRemark}'>
							<span class="Validform_checktip"></span>

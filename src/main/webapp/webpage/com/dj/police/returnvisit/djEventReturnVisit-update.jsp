...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djEventReturnVisitController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="returnResponPolice" name="returnResponPolice" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djEventReturnVisitPage.returnResponPolice}'>
					...
					<tr>
						...
						<td class="value">
									  <input id="returnTime" name="returnTime" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djEventReturnVisitPage.returnTime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="returnName" name="returnName" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djEventReturnVisitPage.returnName}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djEventReturnVisitPage.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="returnTel" name="returnTel" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djEventReturnVisitPage.returnTel}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="returnResult" name="returnResult" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djEventReturnVisitPage.returnResult}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="returnRemark" name="returnRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djEventReturnVisitPage.returnRemark}'>
							<span class="Validform_checktip"></span>

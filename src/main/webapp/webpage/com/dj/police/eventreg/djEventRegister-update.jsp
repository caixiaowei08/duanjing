...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djEventRegisterController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
									  <input id="eventTirme" name="eventTirme" type="text" style="width: 150px" 
						      						 ...
						      						 value='<fmt:formatDate value='${djEventRegisterPage.eventTirme}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="eventReportTime" name="eventReportTime" type="text" style="width: 150px" 
						      						 ...
						      						 value='<fmt:formatDate value='${djEventRegisterPage.eventReportTime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djEventRegisterPage.name}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djEventRegisterPage.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="eventAddress" name="eventAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djEventRegisterPage.eventAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="eventTel" name="eventTel" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djEventRegisterPage.eventTel}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="eventValue" name="eventValue" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djEventRegisterPage.eventValue}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="eventRemark" name="eventRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djEventRegisterPage.eventRemark}'>
							<span class="Validform_checktip"></span>

...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djInterviewResidentController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="inter" name="inter" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djInterviewResidentPage.inter}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="interRoom" name="interRoom" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djInterviewResidentPage.interRoom}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="interInterviewee" name="interInterviewee" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djInterviewResidentPage.interInterviewee}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="idNo" name="idNo" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djInterviewResidentPage.idNo}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="interTel" name="interTel" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djInterviewResidentPage.interTel}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="interStartTime" name="interStartTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${djInterviewResidentPage.interStartTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="interEndTime" name="interEndTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker()"
						      						 ...
						      						 value='<fmt:formatDate value='${djInterviewResidentPage.interEndTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="interDetail" name="interDetail" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djInterviewResidentPage.interDetail}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="interRemark" name="interRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djInterviewResidentPage.interRemark}'>
							<span class="Validform_checktip"></span>

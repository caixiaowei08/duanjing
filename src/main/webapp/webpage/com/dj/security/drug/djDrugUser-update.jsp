...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="djDrugUserController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
									<t:dictSelect field="sex" type="radio"
										typeGroupCode="sex" defaultVal="${djDrugUserPage.sex}" hasLabel="false"  title="性别"></t:dictSelect>     
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="permanentAddress" name="permanentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDrugUserPage.permanentAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="currentAddress" name="currentAddress" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDrugUserPage.currentAddress}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						   <%--   	 <input id="maritalStatus" name="maritalStatus" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDrugUserPage.maritalStatus}'> --%>
							<t:dictSelect field="maritalStatus" type="list"
										typeGroupCode="m_status" defaultVal="${djDrugUserPage.maritalStatus}" hasLabel="false"  title="婚姻状况"></t:dictSelect>   			       
					...
					<tr>
						...
						<td class="value">
						     	 <input id="drugDrugItem" name="drugDrugItem" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
										       value='${djDrugUserPage.drugDrugItem}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="drugDealTime" name="drugDealTime" type="text" style="width: 150px" 
									               ...
									               datatype="*" 
						      						 value='<fmt:formatDate value='${djDrugUserPage.drugDealTime}' type="date" pattern="yyyy-MM-dd"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="drugResult" name="drugResult" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDrugUserPage.drugResult}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="drugStatus" name="drugStatus" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDrugUserPage.drugStatus}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="drugRemark" name="drugRemark" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${djDrugUserPage.drugRemark}'>
							<span class="Validform_checktip"></span>

...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="djAttentionPrisoner03List" checkbox="true" fitColumns="false" title="刑释解教" actionUrl="djAttentionPrisoner03Controller.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="djAttentionPrisoner03Controller.do?doDel&id={id}" />
   <t:dgToolBar title="录入" icon="icon-add" url="djAttentionPrisoner03Controller.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="djAttentionPrisoner03Controller.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="djAttentionPrisoner03Controller.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="djAttentionPrisoner03Controller.do?goUpdate" funname="detail"></t:dgToolBar>
<%--    <t:dgToolBar title="导入" icon="icon-put" funname="ImportXls"></t:dgToolBar>
 ...
 <script src = "webpage/com/dj/security/attention03/djAttentionPrisoner03List.js"></script>		
 <script type="text/javascript">
 $(document).ready(function(){
 		//给时间控件加上样式
 			$("#djAttentionPrisoner03Listtb").find("input[name='createDate']").attr("class","Wdate").attr("style","height:20px;width:90px;").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
 			$("#djAttentionPrisoner03Listtb").find("input[name='updateDate']").attr("class","Wdate").attr("style","height:20px;width:90px;").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
 			$("#djAttentionPrisoner03Listtb").find("input[name='attentionImprisonTime']").attr("class","Wdate").attr("style","height:20px;width:90px;").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
 });
 
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'djAttentionPrisoner03Controller.do?upload', "djAttentionPrisoner03List");
}

//导出
function ExportXls() {
	JeecgExcelExport("djAttentionPrisoner03Controller.do?exportXls","djAttentionPrisoner03List");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("djAttentionPrisoner03Controller.do?exportXlsByT","djAttentionPrisoner03List");
}
 </script>
...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="djAttentionPrisoner01List" checkbox="true" fitColumns="false" title="服刑人员" actionUrl="djAttentionPrisoner01Controller.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="djAttentionPrisoner01Controller.do?doDel&id={id}" />
   <t:dgToolBar title="录入" icon="icon-add" url="djAttentionPrisoner01Controller.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="djAttentionPrisoner01Controller.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="djAttentionPrisoner01Controller.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="djAttentionPrisoner01Controller.do?goUpdate" funname="detail"></t:dgToolBar>
<%--    <t:dgToolBar title="导入" icon="icon-put" funname="ImportXls"></t:dgToolBar>
 ...
 <script src = "webpage/com/dj/security/attention01/djAttentionPrisoner01List.js"></script>		
 <script type="text/javascript">
 $(document).ready(function(){
 		//给时间控件加上样式
 			$("#djAttentionPrisoner01Listtb").find("input[name='createDate']").attr("class","Wdate").attr("style","height:20px;width:90px;").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
 			$("#djAttentionPrisoner01Listtb").find("input[name='updateDate']").attr("class","Wdate").attr("style","height:20px;width:90px;").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
 			$("#djAttentionPrisoner01Listtb").find("input[name='attentionImprisonTime']").attr("class","Wdate").attr("style","height:20px;width:90px;").click(function(){WdatePicker({dateFmt:'yyyy-MM-dd'});});
 });
 
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'djAttentionPrisoner01Controller.do?upload', "djAttentionPrisoner01List");
}

//导出
function ExportXls() {
	JeecgExcelExport("djAttentionPrisoner01Controller.do?exportXls","djAttentionPrisoner01List");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("djAttentionPrisoner01Controller.do?exportXlsByT","djAttentionPrisoner01List");
}
 </script>
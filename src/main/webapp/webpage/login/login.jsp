...
<body>
    ...
    <div id="login">
        ...
        <div class="inner">
            <div class="logo"><img src="plug-in/login/images/toplogo_v1.png" /><!-- <img src="plug-in/login/images/foot.png" /> --></div>
            <div class="formLogin">
                <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
                    ...
                    <div class="loginButton">
                        ...
                        <div style="float: center; padding: 3px 0; margin-right: -12px;">
                            <div>
                        ...
                        <div style="float: right; padding: 3px 0; margin-right: -12px;">
                                   <select name="langCode" id="langCode"><option value="zh-cn" selected="selected">中文简体</option></select>
                        </div>
                        <div class="clear"></div>
                    </div>
                </form>

...
<%-- <title><t:mutiLang langKey="jeect.platform"/></title>
 --%>
<title><%-- <t:mutiLang langKey="jeect.platform"/> --%>月浦镇综治警务平台</title>
...
<!-- style="BACKGROUND: #A8D7E9; --> 
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr>
    <td align="left" style="vertical-align: text-bottom">
      <img src="plug-in/login/images/logo1.jpg"> 
    <!--
    ...
    <td align="right" nowrap>
        <table border="0" cellpadding="0" cellspacing="0">
            <tr style="height: 25px;" align="right">
                <td style="" colspan="2">
                    <div style="background: url(plug-in/login/images/top_bg.jpg) no-repeat center; float: right;">
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #1fa3e5; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="#" title="JEECG Framework -3.5.2"></a>
